	    ...
	    updateRole(newRole) {
	        ...
	        window.history.replaceState({}, '', url);
						...
						<div class="grid grid-cols-2 gap-3 sm:grid-cols-2 sm:gap-4 mb-6">
							<button type="button" @click="updateRole('brand')"
								:class="role === 'brand' ? 'bg-gray-200 dark:bg-white/10' : 'bg-gray-100 dark:bg-white/5'"
								class="inline-flex items-center justify-center gap-3 rounded-lg px-6 py-3 text-sm font-medium text-gray-700 transition-all dark:text-white">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
									<ellipse cx="10" cy="17.5" rx="7" ry="3.5" stroke="currentColor" stroke-width="1.5"
							...
							<button type="button" @click="updateRole('influencer')"
								:class="role === 'influencer' ? 'bg-gray-200 dark:bg-white/10' : 'bg-gray-100 dark:bg-white/5'"
								class="inline-flex items-center justify-center gap-3 rounded-lg px-6 py-3 text-sm font-medium text-gray-700 transition-all dark:text-white">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
									<path
