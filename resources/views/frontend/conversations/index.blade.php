                    ...
                    <div class="text-center px-8">
                        ...
                        @if ($sidebarConversations->isEmpty())
                            <div class="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 rounded-xl p-6 mb-6">
                                ...
                                <a href="{{ route('influencers') }}" class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-6 rounded-xl transition">
