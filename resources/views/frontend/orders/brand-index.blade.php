...
<div class="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
    <div class="mb-8">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Track and manage all your creator orders in one place</p>
    </div>
    ...
    @if ($orders->isEmpty())
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-sm overflow-hidden">
            <div class="flex flex-col items-center justify-center py-16 px-4 text-center">
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-6">Start collaborating with creators by purchasing their packages</p>
