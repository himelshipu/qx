...
<div class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
    <main class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <section class="w-full">
            <div class=" mx-auto py-4 flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                <div class="flex items-center gap-2">
                    <img src="/images/logo/logo-dark.png" alt="Logo" class="h-8 dark:block hidden">
                    <img src="/images/logo/logo.png" alt="Logo" class="h-8 dark:hidden block">
                </div>

                <nav class="flex flex-wrap items-center justify-center gap-4 md:gap-6 lg:gap-8 text-sm font-medium text-gray-900 dark:text-gray-100">
                    <a href="#" class="hover:text-gray-600 dark:hover:text-gray-300">Search</a>
                    <a href="#" class="hover:text-gray-600 dark:hover:text-gray-300">How It Works</a>
                    <a href="#" class="hover:text-gray-600 dark:hover:text-gray-300">Pricing</a>
                    <a href="#" class="hover:text-gray-600 dark:hover:text-gray-300">Login</a>
                    <a href="#" class="hover:text-gray-600 dark:hover:text-gray-300">Join as Brand</a>
                    <a href="#" class="text-pink-500 hover:underline">Join as Creator</a>
                </nav>
            </div>

            <div class="max-w-7xl mx-auto px-4 py-8 md:py-12 text-center">
                <h1 class="py-2 text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight bg-gradient-to-r from-pink-400 to-fuchsia-600 bg-clip-text text-transparent">
                    Influencer Marketing Made Easy
                </h1>

                <p class=" text-base sm:text-lg text-gray-500 dark:text-gray-400  mx-auto leading-relaxed">
                    Find and hire top Instagram, TikTok, YouTube, and UGC influencers
                    to create unique content for your brand
                </p>
            </div>

            <div class="flex flex-wrap items-center gap-2 justify-center mb-8  mx-auto">
                <x-ui.badge color="light"  variant="custom" 
                :startIcon="view('components.icons.star', ['class' => 'w-4 h-4'])">  Rising Instagram Stars
                </x-ui.badge>

                <x-ui.badge :color="'light'"  variant="custom" 
                :startIcon="view('components.icons.star', ['class' => 'w-4 h-4'])">  Rising TikTok Stars
                </x-ui.badge>

                <x-ui.badge :color="'light'"  variant="custom" 
                :startIcon="view('components.icons.shopping-bag', ['class' => 'w-4 h-4'])">  Fashion
                </x-ui.badge>

                <x-ui.badge :color="'light'"  variant="custom" 
                :startIcon="view('components.icons.happy-face-plus', ['class' => 'w-4 h-4'])">  Beauty
                </x-ui.badge>

                <x-ui.badge :color="'light'"  variant="custom" 
                :startIcon="view('components.icons.heart-plus', ['class' => 'w-4 h-4'])">  Health & Wellness
                </x-ui.badge>

                <x-ui.badge :color="'light'"  variant="custom" 
                :startIcon="view('components.icons.trending-up', ['class' => 'w-4 h-4'])">  Most Viewed
                </x-ui.badge>

                 <x-ui.badge :color="'light'"  variant="custom" 
                :startIcon="view('components.icons.camera', ['class' => 'w-4 h-4'])">  UGC
                </x-ui.badge>
