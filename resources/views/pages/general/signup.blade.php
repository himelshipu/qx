...
<div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
    <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
        ...
        <div class="flex w-full flex-1 flex-col lg:w-1/2"
            ...
            <!-- Back To Dashboard -->
            <div class="px-12 w-full max-w-md pt-10">
                <a href="/"
                    class="inline-flex items-center text-sm text-gray-500 transition-colors hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                    
                    <svg class="stroke-current mr-2" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                ...
                <!-- Title -->
                <div class="mb-8">
                    <h1 class="text-title-sm sm:text-title-md text-center mb-2 font-semibold text-gray-800 dark:text-white/90">
                        Create Your Account
                    </h1>
                ...
                <!-- Role Switch -->
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5 mb-6">
                    ...
                    <button type="button"
                        ...
                        class="inline-flex items-center justify-center gap-3 rounded-lg px-6 py-3 text-sm font-normal text-gray-700 transition-colors hover:bg-gray-200 dark:text-white/90 dark:hover:bg-white/10">
                ...
                <div x-show="role === 'brand'" x-cloak>
                    <x-general.auth.brand-signup-form />
                </div>

                <!-- CREATOR FORM -->
                <div x-show="role === 'creator'" x-cloak>
                    <x-general.auth.creator-signup-form />
                </div>

                <!-- Toggle to Sign In -->
                <div class="mt-5"> 
                    <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400"> Don't have an account? 
                        <a href="/signin" class="text-pink-400 hover:text-pink-500 dark:text-pink-400">Sign In</a>
                    </p>
                 </div>
