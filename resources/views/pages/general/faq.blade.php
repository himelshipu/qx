...
<div class="min-h-screen bg-white dark:bg-gray-950 px-4 sm:px-6 lg:px-8 py-20">
    <main class="max-w-screen-2xl flex flex-col gap-12 mx-auto px-4 sm:px-6 lg:px-8">
        
        <!-- INFLUENCERS -->
        <section x-data="{ activeAccordion: null }">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-12">For Influencers</h2>
        ...
        <!-- BRANDS -->
        <section x-data="{ activeAccordion: null }">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-12">For Brands</h2>
            <div class="divide-y divide-gray-200 dark:divide-gray-800 border-b border-gray-200 dark:border-gray-800">
                
                <div class="py-6">
                    <button @click="activeAccordion = (activeAccordion === 1 ? null : 1)" class="flex w-full items-center justify-between text-left group">
                        <span class="text-lg font-bold text-gray-900 dark:text-white group-hover:text-gray-600 transition-colors">How do I find influencers?</span>
                        <span class="ml-6 flex-shrink-0 text-gray-400">
                            <svg class="h-6 w-6 transition-transform duration-300" :class="activeAccordion === 1 ? 'rotate-45' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6v12m6-6H6" /></svg>
                        </span>
                    </button>
                    <div x-show="activeAccordion === 1" x-collapse x-cloak>
                        <div class="mt-4 text-gray-500 dark:text-gray-400  text-[15px]">
