...
@section('content')
    <x-common.page-breadcrumb pageTitle="Create Brands" />

    <div class="flex flex-col gap-4 justify-between">
        <div class="create-brand-form-wrapper w-2/4 border rounded-lg border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
