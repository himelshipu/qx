@props([
    'influencersByPlatform' => collect(),
])

<section class="w-full space-y-12">


	@forelse ($influencersByPlatform as $platformGroup)
		@php
	...
	@empty
		<div class="rounded-xl border border-dashed border-gray-200 dark:border-gray-700 p-8 text-center">
			<p class="text-sm text-gray-500 dark:text-gray-400">No influencer data available yet.</p>
		</div>
	@endforelse
</section>
