<footer class="mx-auto w-full border-t border-gray-100 dark:border-gray-800">
    ...
    <div class="border-t border-gray-100 dark:border-gray-800">
        <div class="max-w-screen-2xl mx-auto px-2 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
