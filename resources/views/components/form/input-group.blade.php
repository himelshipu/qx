<x-common.component-card title="Input Group">
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" placeholder="contact@rockiesconnect.com" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pl-[62px] text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
        </div>
    </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="url" placeholder="www.rockiesconnect.com"
    ...
    <div id="copy-input">
        ...
        <div class="relative">
            ...
            <input value="www.rockiesconnect.com" type="url" id="website-input"
