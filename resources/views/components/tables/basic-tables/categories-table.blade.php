            ...
            <table class="w-full min-w-full">
                ...
                <thead>
                    <tr class="border-b border-gray-100 dark:border-gray-800">
                        ...
                        <th class="px-5 py-3 text-right sm:px-6">Action</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <template x-for="category in categories" :key="category.id">
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <!-- Actions -->
                            <td class="px-5 py-4 sm:px-6 w-[40%]">
                                <div class="flex gap-3 justify-end">

                                    <!-- Edit -->
                                    <button @click="openEdit(category)"
                                        class="flex gap-2 items-center justify-center w-32 h-12 rounded-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-600 transition">
