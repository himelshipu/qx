...
@section('content')
    ...
    <div class="flex flex-col gap-4 justify-between">
        <div class="create-moderator-form-wrapper w-2/4 border rounded-lg border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
            <form @submit.prevent="step = 'verify'">
                <div class="create-moderator-form space-y-6">
                    <!-- Personal Info -->
                    <div class="grid grid-cols-1 gap-5">
                     ...
                     <!-- Button -->
                    <div class="create-moderator-button">
                        <button
                    ...
                    <!-- Send moderator a notification link -->
                    <div>
                        <label class="inline-flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            Send moderator a notification link to set up their account
                        </label>
                    </div>
                </div>
            </form>
