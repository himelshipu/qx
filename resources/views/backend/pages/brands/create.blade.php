...
@section('content')
	<x-backend.shell.breadcrumb pageTitle="Create Brand" />
	...
	<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
		<div
			...
			<div>
				<h3 class="text-lg font-semibold text-gray-900 dark:text-white">New Brand</h3>
				<p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Create a brand account, contact profile, and visual assets.
				</p>
			</div>
		...
		<form action="{{ route('dashboard.brands.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 p-5">
			@csrf
			...
			@include('backend.pages.brands._form')
