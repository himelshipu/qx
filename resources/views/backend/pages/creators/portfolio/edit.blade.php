...
@section('title', "Edit Portfolio - {$creator->display_name}")
	...
	<div class="max-w-2xl">
		<div class="space-y-6">
			<div>
				...
				<p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update this portfolio item for {{ $creator->display_name }}
				</p>
			</div>

			<form action="{{ route('dashboard.creators.portfolio.update', [$creator, $portfolio]) }}" method="POST"
