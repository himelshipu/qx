...
@section('content')
    <x-backend.shell.breadcrumb pageTitle="Create Creator" />

    <div class="flex flex-col gap-4 justify-between">
        <div class="create-creator-form-wrapper w-2/4 border rounded-lg border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
            <form @submit.prevent="step = 'verify'">
                <div class="create-creator-form space-y-6">
                    <!-- Personal Info -->
