...
@section('content')
	...
	<div class="space-y-6">
		...
		<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
			...
			<div class="p-5">
				<form id="moderator-filters-form" method="GET" action="{{ route('dashboard.moderators.index') }}"
									...
									<td class="px-4 py-3">
										<div class="flex items-center justify-end gap-2">
											...
											<form action="{{ route('dashboard.moderators.destroy', $moderator) }}" method="POST">
												...
												@method('DELETE')
												<button type="submit"
													data-confirm-title="Delete Moderator"
													data-confirm-message="Delete this moderator? This action cannot be undone."
	...
	@push('scripts')
		<script>
			document.addEventListener('DOMContentLoaded', function() {
				const form = document.getElementById('moderator-filters-form');
				const resultsId = 'moderators-results';
