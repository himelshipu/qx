...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Create Moderator</h2>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Add a new moderator to your platform</p>
            </div>
    ...
    <form action="{{ route('dashboard.moderators.store') }}" method="POST" class="p-6">
        @csrf
