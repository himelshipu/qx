...
@section('content')
	<x-backend.shell.breadcrumb pageTitle="Edit Campaign" />
	...
	<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
		<div
			...
			<div>
				<h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit: {{ $campaign->title }}</h3>
				<p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update campaign details, targeting, and publication status.
				</p>
			</div>
