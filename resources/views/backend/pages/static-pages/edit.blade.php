...
@section('content')
	<x-backend.shell.breadcrumb pageTitle="Edit Static Page" />
	...
	<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
		...
		<form action="{{ route('dashboard.static-pages.update', $page) }}" method="POST" enctype="multipart/form-data" novalidate
			class="space-y-6 p-5">
			@csrf
			@method('PUT')
