...
@section('content')
	<x-backend.shell.breadcrumb pageTitle="Create Influencer" />
	...
	<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
		<div
			...
			<div>
				<h3 class="text-lg font-semibold text-gray-900 dark:text-white">New Influencer</h3>
				<p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Create an influencer account, assign categories, and set profile
					assets.</p>
			</div>
		...
		<form action="{{ route('dashboard.influencers.store') }}" method="POST" enctype="multipart/form-data" novalidate
			...
			@include('backend.pages.influencers._form', ['categoryOptions' => $categoryOptions])
