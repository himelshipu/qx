...
@section('content')
	...
	<div class="space-y-6">
		...
		<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
			...
			<div class="p-5">
				<form method="GET" action="{{ route('dashboard.packages.index') }}"
					...
					<div>
						<label for="platform"
							class="mb-1 block text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Platform</label>
