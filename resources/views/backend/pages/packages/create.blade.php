...
@section('content')
	<x-backend.shell.breadcrumb pageTitle="Create Package" />
	...
	<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
		...
		<form action="{{ route('dashboard.packages.store') }}" method="POST" novalidate class="space-y-6 p-5">
			@csrf

			@include('backend.pages.packages._form')
