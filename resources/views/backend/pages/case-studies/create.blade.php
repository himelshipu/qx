...
@section('content')
	...
	<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
		<div
			...
			<div>
				<h3 class="text-lg font-semibold text-gray-900 dark:text-white">New Case Study</h3>
				<p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Create a case study to showcase successful collaborations.</p>
			</div>
		...
		<form action="{{ route('dashboard.case-studies.store') }}" method="POST" enctype="multipart/form-data" novalidate
			class="space-y-6 p-5">
			@csrf
