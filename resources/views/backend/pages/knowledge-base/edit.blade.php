...
@section('content')
	<x-backend.shell.breadcrumb :links="[['label' => 'Knowledge Base', 'url' => route('dashboard.knowledge-base.index')]]" pageTitle="Edit Article" />

	<div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
		<form action="{{ route('dashboard.knowledge-base.update', $article) }}" method="POST" class="p-6">
			@csrf
			@method('PUT')
