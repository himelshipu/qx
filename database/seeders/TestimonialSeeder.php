    ...
    public function run(): void
    {
        $testimonials = [
            ...
            [
                ...
                'quote' => 'What stood out is how quickly we could launch multiple creator briefs. Reporting and communication are much smoother than our old workflow.',
                'rating' => 4,
                'is_published' => true,
                'sort_order' => 3,
            ],
            [
                ...
                'quote' => 'We were able to test educational creator angles with low friction. The first campaign already beat our benchmark CPA.',
                'rating' => 4,
                'is_published' => false,
                'sort_order' => 4,
            ],
