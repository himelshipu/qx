    ...
    public function run(): void
    {
        $articles = [
            [
                ...
                'summary' => 'Learn the exact steps to create a clear brief so influencers can apply faster and deliver the right content.',
                'content' => "To submit your first campaign brief, go to Dashboard > Campaigns > New Campaign.\n\nStart by defining your campaign goal, target audience, and expected influencer deliverables. Add examples of tone, visual references, and mandatory talking points so submissions stay aligned.\n\nBefore publishing, double-check your budget range, timeline, and approval flow. A complete brief usually receives better applications within the first 24 to 48 hours.",
                'read_time_minutes' => 5,
                'is_featured' => true,
                'is_published' => true,
            ...
            [
                'title' => 'How influencer approval works',
                'slug' => 'how-influencer-approval-works',
                'badge' => 'Campaigns',
                'summary' => 'A practical overview of reviewing applicants, shortlisting influencers, and sending final approvals.',
                'content' => "When applications arrive, open your campaign and review each influencer profile, audience fit, and content history.\n\nUse shortlist to keep top candidates, then approve influencers in batches or one by one. Approved influencers receive automatic notifications and can start deliverables immediately.\n\nIf you need revisions before approval, use the campaign conversation thread to ask questions and clarify requirements.",
                'read_time_minutes' => 6,
                'is_featured' => false,
                'is_published' => true,
            ...
            [
                ...
                'badge' => 'Content',
                'summary' => 'See how drafts, revisions, and final approval are handled between brand and influencer teams.',
                'content' => "Influencers submit draft assets in the campaign deliverables section. You can review each file, leave comments, and request revisions where needed.\n\nOnce all requirements are met, approve the final asset set to move the campaign forward.\n\nKeep feedback specific and actionable to reduce turnaround time and improve influencer response quality.",
                'read_time_minutes' => 4,
                'is_featured' => true,
                'is_published' => true,
            ...
            [
                ...
                'content' => "Campaign reporting shows top-level and per-influencer performance signals.\n\nStart with reach and engagement to measure content visibility and audience interaction, then compare CTR and conversion to evaluate business outcomes.\n\nUse these metrics to refine influencer selection, creative direction, and audience targeting in your next brief.",
                'read_time_minutes' => 6,
                'is_featured' => false,
                'is_published' => true,
